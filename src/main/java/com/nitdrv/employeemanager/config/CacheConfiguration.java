package com.nitdrv.employeemanager.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.nitdrv.employeemanager.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.nitdrv.employeemanager.repository.UserRepository.USERS_BY_EMAIL_CACHE);
