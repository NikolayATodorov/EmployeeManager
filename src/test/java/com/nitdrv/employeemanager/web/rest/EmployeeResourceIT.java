...
import com.nitdrv.employeemanager.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
        return employee;
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
