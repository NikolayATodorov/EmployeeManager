...
import { sampleWithRequiredData } from '../employee-project.test-samples';
...
describe('EmployeeProject Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, EmployeeProjectComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employeeProjects?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to employeeProjectService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmployeeProjectIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmployeeProjectIdentifier).toHaveBeenCalledWith(entity);
