...
describe('EmployeeProject Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { employeeProject: () => of({ id: 123 }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load employeeProject on init', async () => {
      const harness = await RouterTestingHarness.create();
      const instance = await harness.navigateByUrl('/', EmployeeProjectDetailComponent);

      // THEN
      expect(instance.employeeProject()).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
